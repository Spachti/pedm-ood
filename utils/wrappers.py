...
class MujocoReacherImageWrapper(gym.Wrapper):
    def __init__(self, env):
        super(MujocoReacherImageWrapper, self).__init__(env)
        
        # Modify observation space to accept images
    ...
    def _get_observation(self):
        # Capture screen output of Mujoco simulation as observation
        # Replace this with your code to capture the screen output
        observation = np.random.randint(0, 256, size=(64, 64, 3), dtype=np.uint8)
        return observation
