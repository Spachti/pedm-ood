...
from pedm.nn_models.prob_dyn_model import PEDM  # noqa


class PEDM_Detector(Base_Detector):
    """Probabilistic Ensemble Dynamics Model ODD Detecotr for RL agents"""
    ...
    def _predict_scores(self, obs, acts) -> np.ndarray:
        """given a list of transitions (sequential observations and actions) predict the anomaly score
           of each transition based on the criterion and aggregation function
